...
const contactInfo = [
  ...
  },
  {
    ...
    label: 'Email Us',
    value: 'info@Disharealty.com',
    href: 'mailto:info@Disharealty.com',
    ...
    <main className="w-full overflow-x-hidden">
      ...
      <section className="relative pt-[160px] px-[52px] pb-[100px] overflow-hidden bg-gradient-to-br from-[#0d1e2c] to-[#1a3248] flex items-center justify-center text-center min-h-screen">
        ...
        <div className="relative z-10 max-w-[700px]">
          <p className={`${sectionKicker} !text-accent-light`}>Get In Touch</p>
          <h1 className="text-[clamp(36px,5vw,62px)] font-black text-white mb-5 tracking-[-0.02em]">Contact Disha Realty</h1>
        ...
        <div className="max-w-[1200px] mx-auto px-[52px] max-lg:px-8 max-sm:px-5">
          <div className="grid grid-cols-[1.1fr_0.9fr] gap-16 items-start max-lg:grid-cols-1 max-lg:gap-12">
            ...
            <div className="reveal from-left">
              <p className={sectionKicker}>Send Us a Message</p>
              <h2 className={sectionTitle}>Let's Start a Conversation</h2>
              ...
              {submitted ? (
                <div className="text-center py-13 px-6 bg-soft rounded-2xl border border-line">
                  ...
                  <button className={btnDark} onClick={() => setSubmitted(false)}>Send Another Message</button>
                </div>
              ) : (
                <form className="flex flex-col gap-5" onSubmit={submit}>
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <select
                      className="bg-[url('data:image/svg+xml,%3Csvg%20viewBox=%220%200%2024%2024%22%20fill=%22none%22%20stroke=%22%237c8a94%22%20stroke-width=%222%22%20xmlns=%22http://www.w3.org/2000/svg%22%3E%3Cpolyline%20points=%226%209%2012%2015%2018%209%22/%3E%3C/svg%3E')] bg-no-repeat bg-[right_14px_center] bg-[length:18px] pr-11 cursor-pointer p-3.5 border-1.5 border-line rounded-lg bg-white text-[15px] text-ink outline-none transition-all duration-250 focus:border-accent focus:shadow-[0_0_0_3px_rgba(26,122,110,0.15)] appearance-none"
                      id="contact-type"
                      name="type"
                      value={form.type}
                      onChange={handle}
                  ...
                  <button type="submit" className={`${btnPrimary} self-start gap-2.5 !min-h-[52px] px-9 text-[15px]`}>
                    Send Message
            ...
            <div className="flex flex-col gap-6 reveal from-right">
              ...
              <div className="relative bg-soft border border-line rounded-2xl min-h-[280px] flex items-center justify-center text-center overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col items-center gap-2.5 p-8">
                  ...
                  <a href="https://maps.google.com" target="_blank" rel="noopener noreferrer" className={`${btnDark} mt-4 !min-h-[40px] px-4 text-[13px]`} style={{ minHeight: 40, fontSize: 13 }}>
                    Open in Google Maps
                  </a>
                </div>
              </div>
